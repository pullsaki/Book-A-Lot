...
public class MailController {
	...
	@GetMapping("mail/endBooking/{bookingid}")
	public void signupMail(@PathVariable Integer bookingid) throws MessagingException, TemplateNotFoundException, MalformedTemplateNameException, ParseException, IOException, TemplateException {
